...
import { AccountInfo, DigestOf, DispatchError, DispatchErrorModule, DispatchErrorTo198, DispatchResult, DispatchResultOf, DispatchResultTo198, Event, EventId, EventIndex, EventRecord, EventRecordTo76, Key, LastRuntimeUpgradeInfo, NodeRole, Phase, RefCount } from '@polkadot/types/interfaces/system';
...
import { Blog, BlogHistoryRecord, BlogId, BlogUpdate, Change, ChangeId, Comment, CommentHistoryRecord, CommentId, CommentUpdate, IpfsHash, OptionBlogId, OptionCommentId, OptionIpfsHash, OptionProfile, OptionText, OptionVecAccountId, OptionWhoAndWhen, Post, PostExtension, PostHistoryRecord, PostId, PostUpdate, Profile, ProfileHistoryRecord, ProfileUpdate, Reaction, ReactionId, ReactionKind, Score, ScoringAction, SocialAccount, SpaceId, SpaceOwners, VecAccountId, VecCommentHistoryRecord, VecProfileHistoryRecord, WhoAndWhen } from '@subsocial/types/substrate/interfaces/subsocial';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    OptionWhoAndWhen: OptionWhoAndWhen;
    'Option<OptionWhoAndWhen>': Option<OptionWhoAndWhen>;
    'Vec<OptionWhoAndWhen>': Vec<OptionWhoAndWhen>;
