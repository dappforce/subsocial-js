...
import { Blog, BlogHistoryRecord, BlogId, BlogUpdate, Change, Comment, CommentHistoryRecord, CommentId, CommentUpdate, IpfsHash, OptionBlogId, OptionChange, OptionCommentId, OptionIpfsHash, OptionProfile, OptionText, OptionVecAccountId, Post, PostExtension, PostHistoryRecord, PostId, PostUpdate, Profile, ProfileHistoryRecord, ProfileUpdate, Reaction, ReactionId, ReactionKind, Score, ScoringAction, SocialAccount, VecAccountId, VecCommentHistoryRecord, VecProfileHistoryRecord } from '@subsocial/types/interfaces/subsocial';
