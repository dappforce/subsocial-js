...
import { AccountId, AccountIdOf, AccountIndex, Address, AssetId, Balance, BalanceOf, Block, BlockNumber, Blog, BlogHistoryRecord, BlogId, BlogUpdate, Call, Change, ChangesTrieConfiguration, Comment, CommentHistoryRecord, CommentId, CommentUpdate, Consensus, ConsensusEngineId, Digest, DigestItem, DispatchClass, DispatchInfo, DispatchInfoTo190, Fixed64, H160, H256, H512, Hash, Header, Index, IpfsHash, Justification, KeyTypeId, KeyValue, LockIdentifier, LookupSource, LookupTarget, Moment, OptionBlogId, OptionChange, OptionCommentId, OptionIpfsHash, OptionProfile, OptionText, OptionVecAccountId, Origin, Perbill, Percent, Permill, Perquintill, Phantom, PhantomData, Post, PostExtension, PostHistoryRecord, PostId, PostUpdate, PreRuntime, Profile, ProfileHistoryRecord, ProfileUpdate, Reaction, ReactionId, ReactionKind, Score, ScoringAction, Seal, SealV0, SignedBlock, SocialAccount, StorageData, ValidatorId, VecAccountId, VecCommentHistoryRecord, VecProfileHistoryRecord, Weight, WeightMultiplier } from '@dappforce/types/interfaces/runtime';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    CommentId: CommentId;
    'Compact<CommentId>': Compact<CommentId>;
    'Option<CommentId>': Option<CommentId>;
    'Vec<CommentId>': Vec<CommentId>;
    ...
    'Option<OptionIpfsHash>': Option<OptionIpfsHash>;
    'Vec<OptionIpfsHash>': Vec<OptionIpfsHash>;
    ...
    VecAccountId: VecAccountId;
    'Option<VecAccountId>': Option<VecAccountId>;
    'Vec<VecAccountId>': Vec<VecAccountId>;
    OptionText: OptionText;
    'Option<OptionText>': Option<OptionText>;
    'Vec<OptionText>': Vec<OptionText>;
    OptionChange: OptionChange;
    'Option<OptionChange>': Option<OptionChange>;
    'Vec<OptionChange>': Vec<OptionChange>;
    OptionBlogId: OptionBlogId;
    'Option<OptionBlogId>': Option<OptionBlogId>;
    'Vec<OptionBlogId>': Vec<OptionBlogId>;
    OptionCommentId: OptionCommentId;
    'Option<OptionCommentId>': Option<OptionCommentId>;
    'Vec<OptionCommentId>': Vec<OptionCommentId>;
    ...
    'Option<CommentUpdate>': Option<CommentUpdate>;
    'Vec<CommentUpdate>': Vec<CommentUpdate>;
    OptionProfile: OptionProfile;
    'Option<OptionProfile>': Option<OptionProfile>;
    'Vec<OptionProfile>': Vec<OptionProfile>;
    ...
    'Option<CommentHistoryRecord>': Option<CommentHistoryRecord>;
    'Vec<CommentHistoryRecord>': Vec<CommentHistoryRecord>;
    VecCommentHistoryRecord: VecCommentHistoryRecord;
    'Option<VecCommentHistoryRecord>': Option<VecCommentHistoryRecord>;
    'Vec<VecCommentHistoryRecord>': Vec<VecCommentHistoryRecord>;
    ...
    VecProfileHistoryRecord: VecProfileHistoryRecord;
    'Option<VecProfileHistoryRecord>': Option<VecProfileHistoryRecord>;
    'Vec<VecProfileHistoryRecord>': Vec<VecProfileHistoryRecord>;
  }
}
