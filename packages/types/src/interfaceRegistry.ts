...
import { AccountId, AccountIdOf, AccountIndex, Address, AssetId, Balance, BalanceOf, Block, BlockNumber, Blog, BlogHistoryRecord, BlogId, BlogUpdate, Call, Change, ChangesTrieConfiguration, Comment, CommentHistoryRecord, CommentId, CommentUpdate, Consensus, ConsensusEngineId, Digest, DigestItem, DispatchClass, DispatchInfo, DispatchInfoTo190, Fixed64, H160, H256, H512, Hash, Header, Index, IpfsHash, Justification, KeyTypeId, KeyValue, LockIdentifier, LookupSource, LookupTarget, Moment, OptionBlogId, OptionChange, OptionCommentId, OptionIpfsHash, OptionProfile, OptionText, OptionVecAccountId, Origin, Perbill, Percent, Permill, Perquintill, Phantom, PhantomData, Post, PostExtension, PostHistoryRecord, PostId, PostUpdate, PreRuntime, Profile, ProfileHistoryRecord, ProfileUpdate, Reaction, ReactionId, ReactionKind, Score, ScoringAction, Seal, SealV0, SignedBlock, SocialAccount, StorageData, ValidatorId, VecAccountId, VecCommentHistoryRecord, VecProfileHistoryRecord, Weight, WeightMultiplier } from '@subsocial/types/interfaces/runtime';
